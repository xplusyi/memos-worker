									...
									<div class='note-meta'> ${index}
										...
										${visibilityIndicator}
											...
											<div class='note-actions view-mode'>
													...
													<div class="visibility-selector" data-visibility="${note.visibility || 'private'}">
														<button type="button" class="visibility-selector-btn text-btn" title="Change visibility">
															<!-- Icon will be set by JS -->
														</button>
														<div class="popover-menu visibility-popover" style="display: none;">
